...
func (r *Router) handleAddCommand(event onebot.Event, groupID string, _ string, _ string, _ string, _ string, _ string) {
...
func (r *Router) handleDeleteCommand(event onebot.Event, groupID string, _ string, _ string, _ string, _ string, _ string) {
	content := event.RawMessage
...
func (r *Router) handleAddRule(event onebot.Event, groupID string, _ string, _ string, _ string, _ string, _ string) {
	content := event.RawMessage
...
func (r *Router) handleDeleteRule(event onebot.Event, groupID string, _ string, _ string, _ string, _ string, _ string) {
	content := event.RawMessage
...
func (r *Router) handleListCommands(event onebot.Event, groupID string, _ string, _ string, _ string, _ string, _ string) {
